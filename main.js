...
function showCart() {
  ...
  if (amount > 0) {
    cardBody.innerHTML = `<div class='d-flex justify-content-center align-items-center gap-2'><img src='images/image-product-1-thumbnail.jpg'  alt=''  width='40px'  height='40px'  class='rounded'/><p class='card-text'>  Fall Limited Edition Sneakers $125.00 x ${amount}  <span class='fw-bolder'>$${
      125 * amount
    }</span></p><img src='images/icon-delete.svg' alt='' /></div><button class='btn btn-warning mx-auto my-3 w-100 py-3 bg-dark-orange text-white'>Checkout</button>`;
  } else {
